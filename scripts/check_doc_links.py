#!/usr/bin/env python3
"""
Comprueba enlaces relativos en ficheros .md del repositorio (excluye vendor común).
Uso: desde la raíz del repo:  python3 scripts/check_doc_links.py
Salida: lista de rutas rotas; código de salida 1 si hay alguna.
"""
...
SKIP_DIRS = {".git", "venv", ".venv", "__pycache__", "node_modules", "pytest-cache-files-wpwprq29"}
