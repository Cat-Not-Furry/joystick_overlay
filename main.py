...
import subprocess
from config import (
	SCREEN_WIDTH, SCREEN_HEIGHT, FPS, get_button_labels, get_background_color,
...
def run_hud_session(screen, profile_data):
	...
	if input_mode == "teclado" and wants_keyboard_remap:
		profile["key_bindings"] = {}
	if input_mode == "teclado" and not profile["key_bindings"]:
	...
	load_icons(button_count, profile["button_icons"])
